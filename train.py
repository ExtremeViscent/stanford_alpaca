...
import wandb
import time
from transformers import GPT2Config, GPT2Model, GPT2Tokenizer, GPT2LMHeadModel, OPTForCausalLM, OPTConfig, AutoTokenizer
...
def train():
    ...
    model_engine, lr_scheduler = ds_init(training_args, model_args, model_conf='/home1/09285/zhangyq/work/virtual_batch/gpt2-800M.json')
    ...
    print(dataloader.__iter__().__next__()['input_ids'].shape)
    print(dataloader.__iter__().__next__()['input_ids'].shape)
    print(data_module["train_dataset"].__getitem__(0)['input_ids'].shape)
    print(data_module["train_dataset"].__getitem__(1)['input_ids'].shape)
    # return
    print(data_module.keys())
    # model_engine, _ = ds_init(training_args, model_args, model_conf='/home1/09285/zhangyq/work/virtual_batch/gpt2-800M.json')
